    ...
    return(
      ...
      <section className="bg-blue-600 mx-4 md:mx-24 text-white flex flex-col items-center justify-center py-8 md:py-16 px-4 md:px-24 h-2/3">
            <div className="relative text-center w-full max-w-[54rem]">
                <h1 className="text-3xl md:text-6xl font-bold mb-4 mt-8 md:mt-24">Welcome.</h1>
                <div className="relative w-full md:max-w-2xl">
                <input
                    className="w-full rounded-full p-3 pl-16 pr-32 text-black"
                    placeholder="Search"
                />
                <button className="absolute top-1/2 right-0 transform -translate-y-1/2 -mr-10 rounded-full bg-blue-800 text-white p-3 hover:bg-blue-900">
                    Search
                </button>
                </div>
            </div>
